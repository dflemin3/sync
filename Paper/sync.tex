...
\begin{figure*}[ht]
	\includegraphics[width=\textwidth]{../Plots/qTauPorbLockHist.pdf}
   \caption{Caption}%
    \label{fig:qTauLock}%
\end{figure*}
...
\subsection{Tidal-Locking as a Function of Eccentricity} \label{sec:results:ecc}

\begin{figure*}[ht]
	\includegraphics[width=\textwidth]{../Plots/eccPorbLockHist.pdf}
   \caption{Caption.}%
    \label{fig:eccLock}%
\end{figure*}

\begin{figure*}[ht]
	\includegraphics[width=\textwidth]{../Plots/eccPorbRatioHist.pdf}
   \caption{Caption.}%
    \label{fig:eccRatio}%
\end{figure*}
...
\subsection{Comparison with \kepler} \label{sec:kepler}

\begin{figure*}[ht]
	\includegraphics[width=\textwidth]{../Plots/lurie.pdf}
   \caption{Caption.}
    \label{fig:lurie}
\end{figure*}
...
\begin{figure}[h]
	\includegraphics[width=0.45\textwidth]{../Plots/example.pdf}
   \caption{Caption}%
    \label{fig:lockingCPL}%
\end{figure}

\begin{figure}[h]
	\includegraphics[width=0.45\textwidth]{../Plots/example.pdf}
   \caption{Caption}%
    \label{fig:lockingCTL}%
\end{figure}
