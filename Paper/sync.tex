...
XXX This subsection is long and meandering. And obvious. I think you can just spend a couple paragraphs pointing out the top-level statistics and then go for the gyrochronology jugular. XXX

be direct, scare gyro people
...
XXX The abov discussion is a bit tricky. Remember that CPL and CTL are truncated infinite series, so locking into 1:1 vs 3:2 might not be the only possible outcomes. In Murray & Dermott they show how one can use a CPL model to produce the "pseudo-equlibrium" period that is a continuous function of $e$. XXX
