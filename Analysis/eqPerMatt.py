...
# Path to sim results
cplDir = "../Sims/CPLTestMatt"
ctlDir = "../Sims/CTLTestMatt"
...
# Save!
fig.tight_layout()
fig.savefig("../Plots/eqPerTwoPanelMatt.pdf",bbox_inches="tight", dpi=600)
...
# Save!
fig.savefig("../Plots/eqPerMatt.pdf", bbox_inches="tight", dpi=600)
...
ax.legend(bbox_to_anchor=[0.59, 0.32], framealpha=0.0, fontsize=17)
ax.set_ylabel("P$_{rot}$/P$_{eq}$", fontsize=30)
ax.set_xlabel("Time [yr]", fontsize=30)
ax.set_xscale("log")
ax.axhline(1, lw=2.5, ls=":", color="k")
...
# Save!
fig.savefig("../Plots/eqPerShortPorbMatt.pdf", bbox_inches="tight", dpi=600)
