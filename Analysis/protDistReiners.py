...
CPL median Prot: 29.687965000000002
CTL median Prot: 29.1996125
Single median Prot: 31.452574500000004

CPL Fraction of Stars with Prot < 7.5 d: 0.0692
CTL Fraction of Stars with Prot < 7.5 d: 0.0673
Single Fraction of Stars with Prot < 7.5 d: 0.0269

CPL Fraction of Stars with Prot < 20 d: 0.228
CTL Fraction of Stars with Prot < 20 d: 0.233
Single Fraction of Stars with Prot < 20 d: 0.1082

CPL Median Age of Stars with Prot < 20 d: 2.6490630945051183
CTL Median Age of Stars with Prot < 20 d: 2.7346587999659704
Single Mediage Age of Stars with Prot < 20 d: 1.6656389380019303

CPL + Age of Stars with Prot < 20 d: 5.434789920095749
CTL + Age of Stars with Prot < 20 d: 5.474016962602814
Single + Age of Stars with Prot < 20 d: 2.605113602559185

CPL - Age of Stars with Prot < 20 d: 1.384067339193213
CTL - Age of Stars with Prot < 20 d: 1.4189953162291897
Single - Age of Stars with Prot < 20 d: 1.189225831520236
...
# Load data
cpl = pd.read_csv("../Data/mcCPLReiners.csv")
ctl = pd.read_csv("../Data/mcCTLReiners.csv")
single = pd.read_csv("../Data/mcSingleReiners.csv")
...
ax1.text(0.4, 90, "CTL", ha="left", va="center", size=30, color="black",
         zorder=100)
...
ax2.text(0.4, 90, "Single Star", ha="left", va="center", size=30, color="black",
         zorder=100)
